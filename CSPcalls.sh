python CSPBusSeats.py ./InputOutputFiles/StudentsHighIds.txt
python CSPBusSeats.py ./InputOutputFiles/StudentsDisabled.txt
python CSPBusSeats.py ./InputOutputFiles/Students3TroubleSiblings.txt
